...
import { DownloaderPanel } from '@modules/downloader/ui/DownloaderPanel'
                ...
                <main className="flex-1 relative flex flex-col items-center justify-center p-8 pb-32 overflow-hidden">
                    ...
                    <div className="relative z-10 group">
                        ...
                        <motion.div
                            ...
                            className={`w-[320px] h-[320px] rounded-full bg-black/50 shadow-2xl relative overflow-hidden border border-white/10 ${playerState === 'playing' ? 'shadow-[0_0_50px_rgba(139,92,246,0.5)]' : 'opacity-90'
                                }`}
                        >
