        ...
        return (
          <div
            ...
            className={cn(
              ...
              isActive
                ? 'bg-white/10 shadow-[0_0_15px_rgba(0,243,255,0.1)] border border-primary/30'
          ...
          >
            ...
            <div
              className={cn(
                'relative w-10 h-10 rounded-md bg-black/30 flex items-center justify-center mr-4 shrink-0 overflow-hidden',
                isActive && 'shadow-[0_0_10px_rgba(0,243,255,0.3)]'
              )}
            >
              {isActive && isPlaying ? (
              ...
              <Play
                size={16}
                className={cn('absolute text-white hidden', !isActive && 'group-hover:block')}
              />
            </div>
            ...
            <div className="flex-1 min-w-0 z-10">
              <div
                className={cn(
                  ...
                  isActive ? 'text-primary drop-shadow-neon' : 'text-white group-hover:text-white',
                  track.status === 'missing' && 'text-red-400 line-through'
                )}
              >
                {track.title}
              </div>
              <div className="text-xs text-white/50 truncate">
                ...
                {track.status === 'missing' && (
                  <span className="text-red-400 ml-2">(File Missing)</span>
                )}
              </div>
            </div>
