...
import { Link, Download, AlertCircle, FolderOpen } from 'lucide-react'
...
export const DownloaderCard = ({ onFilesSelected }: DownloaderCardProps): React.JSX.Element => {
    ...
    const handleBrowse = async (): Promise<void> => {
        if (window.api && window.api.selectAudioFile && onFilesSelected) {
            ...
            <div className="flex flex-col gap-4 relative z-10">
                ...
                <div className="relative flex items-center gap-3">
                    <button
                        ...
                        className="size-12 rounded-xl bg-white/5 border border-white/10 flex items-center justify-center text-white/50 hover:text-white hover:bg-white/10 transition-colors"
